! function(t, e) {
	...
	return function(t) {
		...
		(e = t.exports = n(2)(!1)).push([t.i, ".color-disc-3j_Sx{background-color:#3e3e3e;-webkit-box-sizing:border-box;box-sizing:border-box}", ""]), e.locals = {
		...
		var d = function(t) {
				...
				return function(t, e) {
					...
					value: function() {
						var t = r.a.locals,
							e = this.__getAllFormats(0, 100, 50);
			...
			node: function(t) {
				...
				return function(t, e) {
					...
					value: function() {
						var t = y.a.locals,
							e = this.shadowRoot.getElementById(this.__containerId);
						this.__huePicker = document.createElement("a"), this.__huePicker.classList.add(t.huePicker), this.__huePicker.style.width = "".concat(this.__hueRingRectH, "px"), this.__huePicker.style.height = "".concat(this.__hueRingRectH, "px"), this.__huePicker.style.backgroundColor = "hsl(".concat(this.getAttribute("hue"), ", 100%, 50%)"), this.__huePicker.style.left = "".concat(this.__size - this.__padding - this.__hueRingRectH, "px"), this.__huePicker.style.top = "".concat(this.__half - this.__hueRingRectH / 2, "px"), this.__makeDraggable(this.__huePicker, this.__huePickerMoveHandler.bind(this)), e.appendChild(this.__huePicker)
					}
				}, {
